...
function sitemapIndexTests (options) {
  ...
  return function () {
    browsers.forEach(browser => {
      it(`should succeed for typical sitemap-index usage - ${browser}`, () => {
      ...
      it(`should fail fast for bad sitemap url - ${browser}`, () => {
        return new Promise((resolve, reject) => {
          const done = makeCallback(resolve, reject);
      ...
      it(`should eventually fail for bad page url - ${browser}`, () => {
        return new Promise((resolve, reject) => {
          const done = makeCallback(resolve, reject);
