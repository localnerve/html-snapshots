...
module.exports = {
   ...
   *  args: PHANTOM_SCRIPT OUTPUTFILE URL SELECTOR [TIMEOUT] [INTERVAL]
   */
  selector: function() {
    ...
    if (system.args.length < 4) {
      globals.exit(3, "phantomjs script '"+system.args[0]+"' expected these arguments: OUTPUTFILE URL SELECTOR [TIMEOUT] [INTERVAL] [MODULE]");
    } else {
